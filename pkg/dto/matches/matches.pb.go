...
import (
	...
	game "locgame-service/pkg/dto/game"
...
func file_matches_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_matches_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_matches_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_matches_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_matches_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_matches_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
